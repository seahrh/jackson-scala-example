...
class RootSpec extends FlatSpec with LazyLogging {
  ...
  "Class C" should "serialize to json" in {
    ...
    logger.debug(s"actual=$actual")
    assertResult(
      s"""{"type":"C","rootString":"root=c","l1String":"l1=c","l2String":"l2=c","l2DateTime":"$dts","l2BigDecimal":1.23456789,"l2Boolean":false,"l2Seq":["one","two","three"],"l2Tuple":["hello",1,1.2],"l2Weekday":"Sunday","l2WeekdaySeq":["Tuesday","Wednesday","Thursday"],"l2LongMax":${Long.MaxValue},"l2LongMin":${Long.MinValue},"l2MaxDoubleAsBigDecimal":$maxDoubleAsBigDecimal,"l2MinDoubleAsBigDecimal":$minDoubleAsBigDecimal,"l2Null":null,"l2EmptyArray":[],"l2OptionSome":"some","l2OptionNone":null,"l2WeekdayOption":"Monday","l2WeekdayOptionNone":null}"""
    )(actual)
  }
