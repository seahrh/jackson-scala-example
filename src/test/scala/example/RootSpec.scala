...
class RootSpec extends FlatSpec with LazyLogging {
  ...
  "Class B" should "serialize to json" in {
    ...
    assertResult(
      s"""{"type":"B","rootString":"root=b","rootDateTime":"$dts","rootBigDecimal":1.23456789,"rootBoolean":false,"l1String":"l1=b","rootLongMax":${Long.MaxValue},"rootLongMin":${Long.MinValue},"rootMaxDoubleAsBigDecimal":$maxDoubleAsBigDecimal,"rootMinDoubleAsBigDecimal":$minDoubleAsBigDecimal,"rootNull":null,"rootEmptyArray":[],"rootOptionSome":"some","rootOptionNone":null}"""
    )(b.toJson)
  }
  ...
  "Class C" should "serialize to json" in {
    ...
    assertResult(
      s"""{"type":"C","rootString":"root=c","rootDateTime":"$dts","rootBigDecimal":1.23456789,"rootBoolean":false,"l1String":"l1=c","l2String":"l2=c","rootLongMax":${Long.MaxValue},"rootLongMin":${Long.MinValue},"rootMaxDoubleAsBigDecimal":$maxDoubleAsBigDecimal,"rootMinDoubleAsBigDecimal":$minDoubleAsBigDecimal,"rootNull":null,"rootEmptyArray":[],"rootOptionSome":"some","rootOptionNone":null}"""
    )(c.toJson)
  }
